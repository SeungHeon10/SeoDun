...
public class SecurityConfig {
	...
	public SecurityFilterChain customFilterChain(HttpSecurity http) throws Exception {
	    ...
	    .authorizeHttpRequests(auth -> auth
	        ...
	        .requestMatchers("/users/**", "/", "/login", "/user/register", "/social-login-success", "/signup-extra", "/users/social", "/membership", "/succ-member", "/social-login-success.html", "/.well-known/**", "/css/**", "/fonts/**", "/html/**", "/img/**", "/js/**").permitAll()
